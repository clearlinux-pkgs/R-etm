...
Version  : 0.6.2.1
Release  : 3
URL      : https://cran.r-project.org/src/contrib/etm_0.6-2.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/etm_0.6-2.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530414376
